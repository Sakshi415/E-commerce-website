...
def feedback(request):
    ...
    if request.method == 'POST':
        ...
        data = Feedbackdata(firstname=fname, lastname=lname, comment=comment)
        data.save()
        return render(request, 'userauth/feedbacksuccess.html')
    else:
        return render(request, 'userauth/feedback.html')
